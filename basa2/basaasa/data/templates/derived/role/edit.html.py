...
_magic_number = 5
_modified_time = 1228562743.8749261
_template_filename='/home/veer/eclipse4_workspace/basaasa/basaasa/templates/derived/role/edit.html'
_template_uri='/derived/role/edit.html'
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        __M_writer(u'\n<p>\n')
        # SOURCE LINE 5
        __M_writer(escape(h.form_start(h.url_for(controller='role', action='save',  id=request.urlvars['id']), method="post")))
        __M_writer(u'\n    ')
        # SOURCE LINE 6
