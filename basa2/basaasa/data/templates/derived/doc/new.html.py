...
_magic_number = 5
_modified_time = 1228587947.5821991
_template_filename='/home/veer/eclipse4_workspace/basaasa/basaasa/templates/derived/doc/new.html'
_template_uri='/derived/doc/new.html'
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        __M_writer(u'\n<p>\n')
        # SOURCE LINE 5
        __M_writer(escape(h.form_start(h.url_for(controller='doc', action='create'), method="post")))
        __M_writer(u'\n    ')
        # SOURCE LINE 6
        __M_writer(escape(fields.body()))
        __M_writer(u'\n    ')
        # SOURCE LINE 7
        __M_writer(escape(h.field(field=h.submit(value=_(u"Create document"), name='submit'))))
        __M_writer(u'\n')
        # SOURCE LINE 8
